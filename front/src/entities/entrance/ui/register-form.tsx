...
const titles = {
    [Role.user]: 'Регистрация',
    [Role.cook]: 'Регистрация в студии'
}

export const RegisterFormUI = ({ role, onSubmit, register, children }: {
    role: Role,
    ...
    return (
        <EntraceForm onSubmit={onSubmit}>
            ...
            <Input register={register} name="name" placeholder="Ваше имя:" required />
