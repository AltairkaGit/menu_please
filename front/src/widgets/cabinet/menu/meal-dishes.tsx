...
const variants = {
    in: {
        transition: {
            staggerChindren: 0.07
        }
    },
    out: {
        transition: {
            staggerChindren: 0.05,
            staggerDirection: -1
        }
    }
}
...
export const MealDishes = ({dishes, dish, meal, openModal, setDishId}: 
    ...
    <motion.div key={meal} className="flex p-3 gap-4 min-w-[764px] max-w-[1050px] overflow-x-auto" variants={variants} initial="init" animate="in" exit="out">
