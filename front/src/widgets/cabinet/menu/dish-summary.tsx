...
const variants = {init: {opacity: 0, y: "1rem"}, in: {opacity: 1, y: 0}, out: {opacity: 0, y: "1rem"}}

export const DishSummary = ({dish, className}: {dish: AmountedDish, className?: string}) => (
    <motion.div className={twMerge("flex flex-col gap-4", className)} variants={variants} initial="init" animate="in" exit="out" transition={{duration: 0.5}}>
